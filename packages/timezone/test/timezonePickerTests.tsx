...
describe("<TimezonePicker>", () => {
  ...
  it("if date is non-empty, the timezone offsets will correspond to that date", () => {
    ...
    const timezonePickerJun = shallow(<TimezonePicker {...DEFAULT_PROPS} date={dateJun} showLocalTimezone={false} />);
    const timezonePickerDec = shallow(<TimezonePicker {...DEFAULT_PROPS} date={dateDec} showLocalTimezone={false} />);
