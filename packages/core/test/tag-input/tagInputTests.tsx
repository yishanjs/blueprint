...
describe("<TagInput>", () => {
  ...
  it("values can be valid JSX nodes", () => {
    const values = [<strong key="al">Albert</strong>, undefined, ["Bar", <em key="thol">thol</em>, "omew"], "Casper"];
    const wrapper = mount(<TagInput values={values} />);
  ...
  describe("placeholder", () => {
    ...
    it("setting both shows placeholder when empty and inputProps.placeholder otherwise", () => {
      const wrapper = shallow(<TagInput inputProps={{ placeholder: "inputProps" }} placeholder="props" values={[]} />);
