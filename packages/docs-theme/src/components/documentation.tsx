...
import { Classes, Drawer, FocusStyleManager, Hotkey, Hotkeys, HotkeysTarget, IProps, Utils } from "@yishanzhilubp/core";
  ...
  public getChildContext(): IDocumentationContext {
    ...
    return {
      ...
      renderType: hasTypescriptData(docs)
        ? type => linkify(type, docs.typescript, (name, _d, idx) => <ApiLink key={`${name}-${idx}`} name={name} />)
        : type => type,
        ...
        <div className="docs-app">
          <div className="docs-nav-wrapper">
            <div className="docs-nav" ref={this.refHandlers.nav}>
              ...
              <NavButton icon="search" hotkey="shift + s" text="Search..." onClick={this.handleOpenNavigator} />
              <div className="docs-nav-divider" />
              <NavMenu
          ...
          <main className={classNames("docs-content-wrapper", Classes.FILL)} ref={this.refHandlers.content} role="main">
            <Page
