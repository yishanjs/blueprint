...
import { Cell, Column, Table, TableLoadingOption } from "@yishanzhilubp/table";
  ...
  protected renderOptions() {
    return (
      <>
        ...
        />
        <Switch checked={this.state.rowHeadersLoading} label="Row headers" onChange={this.handleRowHeadersLoading} />
      </>
    );
  }
