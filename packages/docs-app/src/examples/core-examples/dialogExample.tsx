...
import { AnchorButton, Button, Classes, Code, Dialog, H5, Intent, Switch, Tooltip } from "@yishanzhilubp/core";
        ...
        >
          <div className={Classes.DIALOG_BODY}>
            ...
            <p>
              ...
              intermediate analysis to presentation in real time. Every end product created in Foundry becomes a new
              data source that other users can build upon. And the enterprise data foundation goes where the business
              drives it.
            </p>
          ...
          <div className={Classes.DIALOG_FOOTER}>
            <div className={Classes.DIALOG_FOOTER_ACTIONS}>
              ...
              <AnchorButton intent={Intent.PRIMARY} href="https://www.palantir.com/palantir-foundry/" target="_blank">
