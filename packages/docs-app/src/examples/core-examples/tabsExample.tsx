...
import { Alignment, Classes, H3, H5, InputGroup, Navbar, Switch, Tab, TabId, Tabs } from "@yishanzhilubp/core";
...
const EmberPanel: React.SFC<{}> = () => (
  <div>
    ...
    <p className={Classes.RUNNING_TEXT}>
      Ember.js is an open-source JavaScript application framework, based on the model-view-controller (MVC) pattern. It
      allows developers to create scalable single-page web applications by incorporating common idioms and best
