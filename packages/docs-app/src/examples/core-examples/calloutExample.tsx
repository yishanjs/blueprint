...
import { Callout, Code, H5, Intent, Switch } from "@yishanzhilubp/core";
import { Example, handleBooleanChange, handleStringChange, IDocsExampleProps } from "@yishanzhilubp/docs-theme";
    ...
    return (
      <Example options={options} {...this.props}>
        <Callout {...calloutProps} title={showHeader ? "Visually important content" : undefined}>
          The component is a simple wrapper around the CSS API that provides props for modifiers and optional title
          element. Any additional HTML props will be spread to the rendered <Code>{"<div>"}</Code> element.
        </Callout>
      </Example>
    );
  }
