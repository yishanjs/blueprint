...
import { Button, Card, Classes, Elevation, H5, Label, Slider, Switch } from "@yishanzhilubp/core";
  ...
  public render() {
    const options = (
      <>
        ...
        <Label>
          Elevation
          <Slider max={4} showTrackFill={false} value={this.state.elevation} onChange={this.handleElevationChange} />
        </Label>
      </>
    );
