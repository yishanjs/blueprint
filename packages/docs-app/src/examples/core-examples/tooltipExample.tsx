...
import { Button, Classes, H1, Intent, Popover, Position, Switch, Tooltip } from "@yishanzhilubp/core";
  ...
  public render() {
    ...
    return (
      <Example options={false} {...this.props}>
        ...
        <div>
          This line's tooltip{" "}
          <Tooltip className={Classes.TOOLTIP_INDICATOR} content={<span>BRRAAAIINS</span>} isOpen={this.state.isOpen}>
        ...
        >
          <Tooltip content={<span>This button also has a popover!</span>} position={Position.RIGHT} usePortal={false}>
