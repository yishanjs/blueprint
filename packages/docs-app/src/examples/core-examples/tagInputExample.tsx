  ...
  private renderOptions() {
    return (
      <>
        ...
        <H5>Tag props</H5>
        <Switch label="Use minimal tags" checked={this.state.tagMinimal} onChange={this.handleTagMinimalChange} />
        <Switch label="Cycle through intents" checked={this.state.tagIntents} onChange={this.handleTagIntentsChange} />
      </>
    );
  }
