...
import { Button, H5, Intent, ITagProps, MenuItem, Switch } from "@yishanzhilubp/core";
import { Example, IExampleProps } from "@yishanzhilubp/docs-theme";
import { ItemRenderer, MultiSelect } from "@yishanzhilubp/select";
import {
  areFilmsEqual,
  arrayContainsFilm,
  createFilm,
  ...
  protected renderOptions() {
    return (
      <>
        ...
        />
        <Switch label="Reset query on select" checked={this.state.resetOnSelect} onChange={this.handleResetChange} />
        <Switch
        ...
        <H5>Tag props</H5>
        <Switch label="Minimal tag style" checked={this.state.tagMinimal} onChange={this.handleTagMinimalChange} />
        <Switch label="Cycle through tag intents" checked={this.state.intent} onChange={this.handleIntentChange} />
        <H5>Popover props</H5>
        <Switch
