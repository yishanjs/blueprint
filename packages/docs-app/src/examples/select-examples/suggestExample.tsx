...
import { H5, MenuItem, Switch } from "@yishanzhilubp/core";
import { Example, IExampleProps } from "@yishanzhilubp/docs-theme";
import { Suggest } from "@yishanzhilubp/select";
import {
  areFilmsEqual,
  createFilm,
  filmSelectProps,
...
export class SuggestExample extends React.PureComponent<IExampleProps, ISuggestExampleState> {
  ...
  protected renderOptions() {
    return (
      <>
        <H5>Props</H5>
        <Switch label="Close on select" checked={this.state.closeOnSelect} onChange={this.handleCloseOnSelectChange} />
        <Switch
